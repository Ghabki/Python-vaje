...
ime = input("Kraj iz kjer je postavljen top: ")
drugo_ime = input("Drugi kraj iz kjer je postavljen top: ")

domet = float(input("Domet: "))
...
for kraj, x, y in kraji:
    ...
    if razdalja_od_lj <= domet:
        if razdalja_od_lj > a:
            a = razdalja_od_lj
            n_kraj = kraj
print("Iz kraja" , ime , "lahko na naj daljsi razdalji zalijemo kraj" ,n_kraj , "na razdalji" , a)
